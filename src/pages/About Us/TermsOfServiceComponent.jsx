...
// Assuming this CSS file is the same one used for PrivacyPolicyComponent
// and contains styles for .policy-header-banner and .privacy-policy-container
  ...
  return (
    <>
      <div className="policy-header-banner">
        {/* These are for the subtle background effect, same as privacy policy */}
      ...
      <div className="privacy-policy-container"> {/* Using the same class for consistent styling */}
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              ...
              on religion, race, gender, national origin, age, marital
          ...
          <p>
            ...
            posting a review, you hereby grant to us a perpetual, non-
            exclusive, worldwide, royalty-free, fully-paid, assignable, and
            sublicenseable right and license to reproduce, modify, translate,
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              ...
              notice of copyright or trademark) posted by us or the licensors
              of the application;
            </li>
            <li>
            ...
            <li>
              ...
              software that is, directly or indirectly, competitive with or
              in any way a substitute for the application;
            </li>
            <li>
              Use the application to send automated queries to any website or
        ...
        <section>
          ...
          <p>
            ...
            Distributor”) to access the Marketplace Offerings:
          </p>
          <ul>
            <li>
        ...
        <section>
          ...
          <ul>
            ...
            {/* This sub-list needs to be nested or handled carefully */}
            <ul>
                <li>
                    ...
                    limitation any friend lists;
                </li>
                <li>
                    We may submit to and receive from your Third-PartyAccount
                    additional information to the extent you are notified when you
                    link your account with the Third-PartyAccount. Depending on the
                    ...
                    Third-PartyAccounts may be available on and through your
                    account on the Site.
                </li>
            </ul>
          </ul>
          <p>
            Please note that if a Third-PartyAccount or associated service
            ...
            time. ALSO NOTE THAT YOUR RELATIONSHIP WITH THE THIRD-PARTY
        ...
        <section>
          ...
          <p>
            ...
            and you hereby warrant that any such Submissions are original
            with you or that you have the right to submit such Submissions.
            You agree there shall be no recourse against us for any alleged or
