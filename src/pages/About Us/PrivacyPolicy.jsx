...
import './PrivacyPolicy.css'; // Make sure you have this CSS file for styling
...
const PrivacyPolicyComponent = () => {
  return (
    ...
    <div className="privacy-policy-container">
      <p>
        We care about data privacy and security. Please review our Privacy. By
        using the Site or the Marketplace Offerings, you agree to be bound by
      ...
      <p className="date-updated">September 30, 2020</p>

      <section>
        <p>
          Freeshoppsps (Freeshoppsps) values its users’ privacy. This Privacy
          ...
          created to ensure those affiliated with Freeshoppsps of our commitment
        ...
        <p>
          ...
          any point in time Freeshoppsps decides to make use of any personally
        ...
        <p>
          This Policy applies to Freeshoppsps, and it governs any and all data
          collection and usage by us. Through the use of www.Freeshoppsps.com,
        ...
        <p>
          ...
          of information by companies that Freeshoppsps does not control, nor by
      ...
      <section>
        ...
        <p>
          In addition, Freeshoppsps may have the occasion to collect non-personal
        ...
        <p>
          Freeshoppsps may also deem it necessary, from time to time, to follow
          ...
          public. Please rest assured that this site will only collect
          personal information that you knowingly and willingly provide to us
          by way of surveys, completed membership forms, and emails. It is the
          intent of this site to use personal information only for the purpose
          for which it was requested, and any additional uses specifically
      ...
      <section>
        ...
        <p>
          Freeshoppsps does not now, nor will it in the future, sell, rent or
          lease any of its customer lists and/or names to any third parties.
          Freeshoppsps may collect and may make use of personal information to
          ...
          available to you from www.Freeshoppsps.com
        </p>
        <p>
          Freeshoppsps may also be in contact with you with regards to
      ...
      <section>
        ...
        <p>
          Freeshoppsps may not use or disclose the information provided by you
      ...
      <section>
        ...
        <p>
          Freeshoppsps greatly respects your privacy. We do maintain and reserve
          ...
          Freeshoppsps products and services). In certain circumstances, we may
      ...
      <section>
        ...
        <p>
          Freeshoppsps&apos;s website is not directed to, and does not knowingly
      ...
      <section>
        ...
        <p>
          ...
          that you wish to unsubscribe to mamunreza2734@gmail.com. If you wish
          to unsubscribe or opt-out from any third-party websites, you must go
          to that specific website to unsubscribe or opt-out. Freeshoppsps&apos;s
          will continue to adhere to this Policy with respect to any personal
      ...
      <section>
        ...
        <p>
          ...
          Freeshoppsps does not claim nor accept responsibility for any privacy
      ...
      <section>
        ...
        <p>
          Freeshoppsps&apos;s operations are located primarily in the United
      ...
      <section>
        ...
        <ul>
          <li>
            <strong>The right to be informed:</strong> this means we must
            inform you of how we intend to use your personal data and we do
            this through the terms of this Policy.
          </li>
          <li>
            <strong>The right of access:</strong> this means you have the
            right to request access to the data we hold about you and we must
            respond to those requests within one month. You can do this by
            sending an email to mamunreza2734@gmail.com.
          </li>
          <li>
            <strong>The right to rectification:</strong> this means that if
            you believe some of the date, we hold is incorrect, you have the
            right to have it corrected. You can do this by logging into your
            account with us, or by sending us an email with your request.
          </li>
          <li>
            <strong>The right to erasure:</strong> this means you can request
            that the information we hold be deleted, and we will comply unless
            we have a compelling reason not to, in which case you will be
            informed of same. You can do this by sending an email to
            mamunreza2734@gmail.com.
          </li>
          <li>
            <strong>The right to restrict processing:</strong> this means you
            can change your communication preferences or opt-out of certain
            communications. You can do this by sending an email to
            mamunreza2734@gmail.com.
          </li>
          <li>
            <strong>The right of data portability:</strong> this means you can
            obtain and use the data we hold for your own purposes without
            explanation. If you wish to request a copy of your information,
            contact us at mamunreza2734@gmail.com.
          </li>
          <li>
            <strong>The right to object:</strong> this means you can file a
            formal objection with us regarding our use of your information
            with regard to third parties, or its processing where our legal
            basis is our legitimate interest in it. To do this, please send an
            email to mamunreza2734@gmail.com.
          </li>
        </ul>
        <p>
      ...
      <section>
        <h2>Security</h2>
        <p>
          Freeshoppsps takes precautions to protect your information. When you
        ...
        <p>
          ...
          information. In addition, Freeshoppsps is a licensee of TRUSTe. The
      ...
      <section>
        ...
        <p>
          ...
          <br />
          Email: mamunreza2734@gmail.com
          <br />
          Telephone Number: 646-664-5812
          <br />
          Mailing Address: &quot;Freeshoppsps&quot; Queens, New York ,11102
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          the General Data Protection Regulation (“GDPR”)? then the Privacy
          ...
          regulations your company must fulfill other requirements such as: (i)
          doing an assessment of data processing activities to improve
          security; (ii) have a data processing agreement with any third party
          vendors; (iii) appoint a data protection officer for the company to
          monitor GDPR compliance; (iv) designate a representative based in
          the EU under certain circumstances; and (v) have a protocol in place
          to handle a potential data breach. For more details on how to make
          sure your company is fully compliant with GDPR, please visit the
          official website at https://gdpr.eu. FormSwift and its subsidiaries
          are in no way responsible for determining whether or not your
          company is in fact compliant with GDPR and takes no responsibility
          for the use you make of this Privacy Policy or for any potential
          liability your company may face in relation to any GDPR compliance
          issues.
        </p>
      </section>

      <section>
        <h2>COPPA Compliance Disclosure:</h2>
        <p>
          ...
          lead to law enforcement actions, including civil penalties. In order
          to be fully compliant with COPPA your website or online service must
          fulfill other requirements such as: (i) posting a privacy policy
          which describes not only your practices, but also the practices of
          any others collecting personal information on your site or service —
          for example, plug-ins or ad networks; (ii) include a prominent link
          to your privacy policy anywhere you collect personal information from
          children; (iii) include a description of parental rights (e.g. that
          you won’t require a child to disclose more information than is
          reasonably necessary, that they can review their child’s personal
          information, direct you to delete it, and refuse to allow any
          further collection or use of the child’s information, and the
          procedures to exercise their rights); (iv) give parents “direct
          ...
          https://www.ftc.gov/tips-advice/businesscenter/
          guidance/childrens-online-privacy-protection-rule-six-step-compliance.
          ...
          COPPA and takes no responsibility for the use you make of this
          Privacy Policy or for any potential liability your company may face
          in relation to any COPPA compliance issues.
        </p>
      </section>
    </div>
