...
const handleSubmit = async (e) => {
  ...
  try {
    const response = await postApi(`api/v1/user/addJobs`, formData, { setLoading });

    if (response.status === 409 && response.message === "Jobs already exists.") {
      setLoading(false);
      return Swal.fire({
        title: "Error",
  ...
  return (
    <div className="container shadow py-3 my-3 px-4">
